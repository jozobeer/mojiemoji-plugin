...
mojiemoji(漢字熟語 / 略語 / カタカナ語のテキストスタンプ)と絵文字(Unicode シンボル)は 2 つの層で、**組み合わせるための道具**である。固定テンプレートに頼らず、本文ごとにパターンを変え、自由に混ぜる。`${CLAUDE_PLUGIN_ROOT}/skills/mojiemoji-github/references/` 配下の各 reference は非<img src="https://mojiemoji.jozo.beer/emoji/%E7%B6%B2%E7%BE%85?font=kurobara&amp;color=fbbf24&amp;animation=gatagata&amp;background=transparent&amp;outline=06d977&amp;outline_width=2" alt="網羅" height="24" align="absmiddle">的な踏み台であって、レシピではない。
...
2. アンカー付きで lookup — `grep -E "^  $EMOJI:" skills/mojiemoji-github/data/emoji-catalog.yml`(行頭 2-space + key + `:`)で**実 YAML <img src="https://mojiemoji.jozo.beer/emoji/%E3%82%AD%E3%83%BC?font=chikara&amp;color=a855f7&amp;animation=yoko_scroll&amp;background=transparent&amp;outline=f7a855&amp;outline_width=2" alt="キー" height="24" align="absmiddle">**にだけマッチさせる。`grep "<emoji>" skills/mojiemoji-github/data/emoji-catalog.yml` <img src="https://mojiemoji.jozo.beer/emoji/%E5%8D%98%E4%BD%93?font=akzk&amp;color=fdba74&amp;animation=tate_scroll&amp;background=transparent&amp;outline=74fdba&amp;outline_width=2" alt="単体" height="24" align="absmiddle">は header コメント中の例 (`🚀` 等) にも当たって false positive になる。
