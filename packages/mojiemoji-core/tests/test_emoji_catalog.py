"""Validate the emoji catalog shipped with the package against the canonical
...
from mojiemoji.prestamp.catalog import DEFAULT_EMOJI_CATALOG_PATH

CATALOG_PATH = DEFAULT_EMOJI_CATALOG_PATH
