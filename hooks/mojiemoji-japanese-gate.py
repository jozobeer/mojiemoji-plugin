...
# replaced with <img> tags before AI adds any decoration; when that
# step is skipped, those terms remain plain text and the AI's manual
# decoration burns tokens on what could have been a deterministic
# substitution. Threshold-based to absorb single-term natural recurrence
# (e.g., a body discussing 「対応」 incidentally once).
CATALOG_PATH = (
