"""Stage 5 — "下処理 first" gate (issue #70).

Catches bodies posted without running prestamp.py first. The catalog
has 450+ frequent 2-char terms that should be mechanically replaced
with <img> tags before AI adds any decoration; when that step is
...
Threshold-based to absorb single-term natural recurrence (e.g., a
body discussing 「対応」 incidentally once).
"""
...
from lib.term_boundaries import count_occurrences  # type: ignore[import-not-found]
